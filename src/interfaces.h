...
#ifndef INTERFACES_H_1323191194
#define INTERFACES_H_1323191194
...
public:
    ...
    { setProperty("DebugLevel", qVariantFromValue(value)); }
    ...
    { setProperty("DebugShowKeys", qVariantFromValue(value)); }
    ...
    { setProperty("DebugTimestamp", qVariantFromValue(value)); }
...
public Q_SLOTS: // METHODS
    ...
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(ifname);
